  ...
  return (
    <main className="font-montserrat relative px-4 py-12 md:pt-8 pb-24 max-w-[1440px] mx-auto">
      ...
      <div className="max-w-[1280px] mx-auto mb-8">
        <h1 className="relative w-fit first-line:font-thin text-[28px] text-center text-gray-900 mb-10 leading-[60px] mx-auto sm:text-3xl sm:leading-[80px] md:text-4xl md:leading-[100px]">
          ...
          marketplace where <br className="hidden sm:block" /> buyers shop, and sellers grow their <br className="hidden sm:block" /> businesses
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
          <Link href="https://chat.whatsapp.com/E9fDd3thS80Ko35yKtZljW" target="_blank">
            <Button variant="outline" className="bg-[#006ED3] border-[#006ED3] text-white text-base hover:bg-white hover:text-[#006ED3] px-8 py-5">
              Join Our Community
            </Button>
          </Link>
          <Link href="#categories">
            <Button variant="outline" className="border-[#FF8B2A] text-[#FF8B2A] text-base hover:bg-[#FF8B2A] hover:text-white px-8 py-5">
              Become a Seller
            </Button>
          </Link>
        </div>
