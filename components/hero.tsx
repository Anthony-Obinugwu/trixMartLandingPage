      ...
      <div className="max-w-[1280px] mx-auto mb-8">
        ...
        transition={{duration: 0.6}}
         className="relative w-fit font-extralight text-[28px] text-center text-gray-900 mb-10 leading-[60px] mx-auto sm:text-3xl sm:leading-[80px] md:text-4xl md:leading-[80px] lg:text-5xl lg:leading-[96px]" >
          <motion.div
          animate={{x: [0, -20, 20, -10, 10, 0], rotate: [0, -5, 5, -2, 2, 0]}}
          transition={{duration: 2, delay: 3, repeat: Infinity, repeatDelay: 5}}
          >
            <Image src="/page-vectors/trixmart-banner.svg" className="absolute -top-10 left-4 -z-10 sm:-top-6 sm:left-8 md:-top-8 md:w-36" width={120} height={200} alt="" />
          </motion.div>
