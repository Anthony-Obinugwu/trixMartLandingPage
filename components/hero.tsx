...
export default function Hero() {
  return (
    <main className="font-montserrat relative px-4 py-12 md:pt-8 pb-24 max-w-[1440px] mx-auto">
      <Image src="/hero-image.png" className="hidden sm:inline-block sm:absolute sm:bottom-0 sm:right-0 sm:-z-10 md:-bottom-8 md:w-64 lg:w-72 lg:h-auto" width={210} height={50} alt="student-emphasis" />
