...
function CategoryCard({ title, image, items = [], defaultExpanded = false }: CategoryCardProps) {
  ...
  return (
    <div className="relative rounded-2xl overflow-hidden">
      <div className="relative h-[273px]"> {/* Original height */}
        <Image
          src={image || "/food.png"}
          alt={title}
          width={724}
      ...
      <div
        className={cn(
          ...
          isExpanded ? "max-h-[150px] mt-6 opacity-100 overflow-y-auto" : "max-h-0 opacity-0", // Original max height and added overflow-y-auto
        )}
      >
