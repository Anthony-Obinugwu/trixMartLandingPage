    ...
    <section id="about" className="font-montserrat pt-8 pb-16">
      <div className="container mx-auto px-4">
        ...
        <motion.p
          ...
          className="font-light text-base text-center leading-relaxed mb-12 sm:text-lg sm:leading-8">Who are we and what do we stand for?</motion.p>
        ...
        <div className="sm:flex sm:flex-row sm:justify-between sm:items-start sm:gap-x-10 md:px-12 md:gap-x-20 lg:gap-48">
          ...
          <div id="paragraph-and-button" className="flex flex-col items-center mb-16 sm:items-start">
            <motion.p
              ...
              className="text-base text-center leading-relaxed sm:text-left sm:leading-8 lg:leading-10">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.4, delay: 0.5 }}
            className="font-bold text-[#006ED3] text-xl text-center my-8 sm:text-2xl lg:text-nowrap">
            Hmm...What else?
          </motion.div>
        </div>
