      ...
      <div className="container mx-auto px-4">
        ...
        <motion.p
          ...
          transition={{duration: 0.4, delay: 0.3}}
           className="font-light text-base text-center leading-8 mb-12 sm:text-lg sm:mb-28">What are the benefits of joining Trix Mart?</motion.p >
...
function BenefitsCard({isDirectionLeft=false, benefactor, benefitsList}: BenefitsProps){
  return (
    ...
    viewport={{once: true}}
    transition={{duration: 0.4, delay: 0.3}}
     className="relative px-10 sm:static sm:px-0">
